                        ...
                        <div class="navbar-collapse collapse justify-content-end" id="navbar-collapse-toggle-1">
                            <ul id="accordion" class="nav navbar-nav no-margin alt-font text-normal" data-in="fadeIn" data-out="fadeOut">
                                ...
                                <li class="dropdown megamenu-fw">
                                    <a href="blog-list-full-width.html">Writings</a>
                                </li>
                                <!-- end menu item -->
                            </ul>
                        </div>
            ...
            <div class="container text-center one-third-screen md-height-350px sm-height-500px xs-height-auto xs-padding-40px-top xs-padding-50px-bottom">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 display-table one-third-screen md-height-350px sm-height-500px xs-height-auto text-center wow bounceInRight xs-height-auto">
                        <div class="display-table-cell vertical-align-middle">
                            <div class="font-weight-300 alt-font title-large text-extra-dark-gray display-inline-block vertical-align-bottom margin-auto">Computation <span class="font-weight-600 position-relative">+ Design</span></div>
                            ...
                            <div class="text-extra-dark-gray text-medium margin-40px-top letter-spacing-0.5 alt-font xs-margin-10px-top">I design product that has impact on scale using Human centered Design Practices. I work at <a class="text-deep-pink" href="https://www.gartner.com/en">Gartner</a>. Previously worked at <a class="text-deep-pink" href="https://www.gartner.com/en">Allstate</a>, <a class="text-deep-pink" href="https://www.gartner.com/en">JDA</a>,
                              <a class="text-deep-pink" href="https://www.gartner.com/en">GTNexus</a>. I contribute my thoughts on Product Design through <a class="text-deep-pink" href="https://www.gartner.com/en">blog</a>. You can find my other work on <a class="text-deep-pink" href="https://www.gartner.com/en">behance</a>, <a class="text-deep-pink" href="https://www.gartner.com/en">codepen</a>, <a class="text-deep-pink" href="https://www.gartner.com/en">github</a>.</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 no-padding-lr xs-padding-15px-lr">
                        <div class="filter-content overflow-hidden">
                            <ul class="portfolio-grid portfolio-metro-grid work-6col hover-option8 gutter-medium">
                                <li class="grid-sizer"></li>
                                <!-- start portfolio item -->
                                <li class="grid-item grid-item-double design wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <!-- end portfolio item -->
                                <!-- start portfolio item -->
                                <li class="grid-item grid-item-double branding web wow fadeInUp">
